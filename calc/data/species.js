...
var ADV_PATCH = {
    ...
    Sceptile: {
        types: ['Grass', 'Dragon'],
        bs: { hp: 78, at: 110, df: 76, sa: 85, sd: 81, sp: 122 },
        weightkg: 52.2,
        abilities: { 0: 'Tinted Lens' }
    },
    Sealeo: {
...
var DPP_PATCH = {
    ...
    Honchkrow: {
        types: ['Dark', 'Flying'],
        bs: { hp: 90, at: 90, df: 89, sa: 115, sd: 74, sp: 88 },
        weightkg: 27.3,
    ...
    Yanmega: {
        types: ['Bug', 'Flying'],
        bs: { hp: 86, at: 71, df: 83, sa: 106, sd: 70, sp: 124 },
        weightkg: 51.5,
        abilities: { 0: 'Tinted Lens' }
    },
    Tynamo: {
